...
const contentSignalsPreamble = `# As a condition of accessing this website, you agree to abide by the
...
License: https://pulletsforever.com/license.xml`;

export default function (eleventyConfig: EleventyConfig) {
  eleventyConfig.addPlugin(sharedPlugin, {
    url: "https://pulletsforever.com",
    language: "en",
    securityContact: "mailto:security@pulletsforever.com",
    sitemap: { permalink: "/.well-known/sitemap.xml" },
    robots: {
      permalink: "/.well-known/robots.txt",
      preamble: contentSignalsPreamble,
      directives: [
        "Content-signal: search=yes, ai-input=yes, ai-train=yes",
        "Allow: /",
      ],
    },
    fourOhFour: { layout: "layouts/base.njk" },
    disableConfig: {
      dateFilters: true,
      bundles: true,
      images: true,
